...
<sitemesh:decorate decorator="/WEB-INF/views/layout/default/header.jsp" />
<sitemesh:decorate decorator="/WEB-INF/views/layout/default/nav.jsp" />
<div id="page_content">
    <div id="page_content_inner">
        <sitemesh:write property="body" />
    </div>
</div>
<sitemesh:decorate decorator="/WEB-INF/views/layout/default/footer.jsp" />
